...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border-t-4 border-red-600">
        ...
        <p class="text-center text-sm text-gray-500 mb-6">
            Daftar dengan email & password, atau gunakan akun Google Anda.
        </p>
            ...
            <div class="mt-4 grid grid-cols-1 gap-3">
                <a href="{{ route('auth.google') }}"
                   class="w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    ...
                    <span class="ml-2">Daftar / Masuk dengan Google</span>
                </a>
            </div>

            <p class="mt-3 text-xs text-gray-500 text-center">
                Jika Anda mendaftar menggunakan Google, akun Google tersebut akan otomatis
                tertaut ke {{ config('app.name') }} dan digunakan untuk integrasi YouTube.
                Jika sudah pernah login Google sebelumnya, kami tidak akan meminta tautan ulang.
            </p>
        </div>
